...
namespace test.org.bn.coders.ber
{
	...
	public class BERCoderTestUtils:CoderTestUtilities
	{
        ...
        public override byte[] createExtensionWithDefaultMismatchBytes()
        {
            return new byte[] { 0x30, 0x0E, 0x06, 0x03, 0x55, 0x1D, 0x0F, 0x01, 0x01, 0xFF, 0x04, 0x04, 0x03, 0x02, 0x04, 0xF0 };
        }

        public override byte[] createExtensionWithDefaultMatchBytesBER()
        {
            // field matching DEFAULT is encoded under BER
            return new byte[] { 0x30,0x47,
                                    0x06,0x03,0x55,0x1D,0x20,
                                    0x01,0x01,0x00,
                                    0x04,0x3D,0x30,0x3B,0x30,0x39,0x06,0x0A,0x2A,0x81,0x7A,0x01,0x81,0x1F,0x01,0x01,0x01,0x02,0x30,0x2B,0x30,0x29,0x06,0x08,0x2B,0x06,0x01,0x05,0x05,0x07,0x02,0x01,0x16,0x1D,0x68,0x74,0x74,0x70,0x3A,0x2F,0x2F,0x69,0x6E,0x74,0x65,0x72,0x69,0x65,0x75,0x72,0x2E,0x67,0x6F,0x75,0x76,0x2E,0x66,0x72,0x2F,0x63,0x73,0x63,0x61 };
        }

        public override byte[] createExtensionWithDefaultMatchBytesDER()
        {
            // field matching DEFAULT is NOT encoded under DER
            return new byte[] { 0x30,0x44,
                                    0x06,0x03,0x55,0x1D,0x20,
                                    0x04,0x3D,0x30,0x3B,0x30,0x39,0x06,0x0A,0x2A,0x81,0x7A,0x01,0x81,0x1F,0x01,0x01,0x01,0x02,0x30,0x2B,0x30,0x29,0x06,0x08,0x2B,0x06,0x01,0x05,0x05,0x07,0x02,0x01,0x16,0x1D,0x68,0x74,0x74,0x70,0x3A,0x2F,0x2F,0x69,0x6E,0x74,0x65,0x72,0x69,0x65,0x75,0x72,0x2E,0x67,0x6F,0x75,0x76,0x2E,0x66,0x72,0x2F,0x63,0x73,0x63,0x61 };
        }

        public override byte[] createSequenceWithExplicitFieldsBytes()
        {
            return new byte[] { 0x30, 0x08, 0xA0, 0x03, 0x02, 0x01, 0x01, 0x02, 0x01, 0x01};
        }
