...
namespace test.org.bn.coders.ber
{
	...
	public class BERCoderTestUtils:CoderTestUtilities
	{
        ...
        public override byte[] createSequenceWithOidBytes()
        {
            return new byte[] { (byte)(0x30), (byte)(0x0A), (byte)(0x06), (byte)(0x03), (byte)(0x55), (byte)(0x04), (byte)(0x06), (byte)(0x02), (byte)(0x03), (byte)(0x11), (byte)(0x22), (byte)(0x33) };
        }

        public override byte[] createDefiniteLengthBasicSequenceBytes()
        {
            return new byte[] { (byte)(0x30), (byte)(0x0C), (byte)(0x02), (byte)(0x03), (byte)(0x11), (byte)(0x22), (byte)(0x33), (byte)(0x04), (byte)(0x05), (byte)(0x4A), (byte)(0x6F), (byte)(0x6E), (byte)(0x65), (byte)(0x73) };
        }

        public override byte[] createIndefiniteLengthBasicSequenceBytes()
        {
            return new byte[] { (byte)(0x30), (byte)(0x80), (byte)(0x02), (byte)(0x03), (byte)(0x11), (byte)(0x22), (byte)(0x33), (byte)(0x04), (byte)(0x05), (byte)(0x4A), (byte)(0x6F), (byte)(0x6E), (byte)(0x65), (byte)(0x73), (byte)(0x00), (byte)(0x00) };
        }        
        ...
        public override byte[] createAttributeBytes()
        {
            return new byte[] { 0x30, 0x23, 0x06, 0x09, 0x2A, 0x86, 0x48, 0x86, 0xF7, 0x0D, 0x01, 0x09, 0x04, 0x31, 0x16, 0x04, 0x14, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0A, 0x0B, 0x0C, 0x0D, 0x0E, 0x0F, 0x11, 0x22, 0x33, 0x44, 0x55 };
        }
