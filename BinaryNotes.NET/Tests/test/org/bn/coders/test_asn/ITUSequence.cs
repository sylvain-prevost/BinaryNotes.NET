...
namespace test.org.bn.coders.test_asn {
    ...
    public class ITUSequence : IASN1PreparedElement 
    {
		...
		[ASN1Element(Name = "type2", IsOptional = false, HasTag = true, Tag = 3, TagClass = TagClasses.Application, HasDefaultValue = false)]
		...
		[ASN1Element(Name = "type4", IsOptional = false, HasTag = true, Tag = 7, TagClass = TagClasses.Application, HasDefaultValue = false)]
